...
def get_model(point_cloud, num_frames, is_training, bn_decay=None):
    ...
    #RADIUS1 = np.linspace(1.0, 1.2, num_frames, dtype='float32')
    RADIUS2 = RADIUS1 * 2
    RADIUS3 = RADIUS1 * 4
    RADIUS4 = RADIUS1 * 8

    
    l1_xyz, l1_time, l1_points, l1_indices = meteor_direct_module8(l0_xyz, l0_time, l0_points, num_point,npoint=1024, radius=RADIUS1, nsample=32, mlp=[32,32], mlp2=[64], group_all=False, knn=False, is_training=is_training, bn_decay=bn_decay, scope='layer1')
    l2_xyz, l2_time, l2_points, l2_indices = meteor_direct_module8(l1_xyz, l1_time, l1_points, num_point,npoint=512, radius=RADIUS2, nsample=32, mlp=[64,64], mlp2=[128], group_all=False, knn=False, is_training=is_training, bn_decay=bn_decay, scope='layer2')
    l3_xyz, l3_time, l3_points, l3_indices = meteor_direct_module8(l2_xyz, l2_time, l2_points, num_point,npoint=128, radius=RADIUS3, nsample=32, mlp=[128,128], mlp2=[256], group_all=False, knn=False, is_training=is_training, bn_decay=bn_decay, scope='layer3')
